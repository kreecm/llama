...
template <typename T> std::string TypeName() { return TypeOf<T>().GetName(); }
...
template <> inline Type TypeOf<std::uint8_t>() { return Type::UInt(8); }
template <> inline Type TypeOf<std::uint16_t>() { return Type::UInt(16); }
template <> inline Type TypeOf<std::uint32_t>() { return Type::UInt(32); }
template <> inline Type TypeOf<std::uint64_t>() { return Type::UInt(64); }
